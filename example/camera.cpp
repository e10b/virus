...
{
	// PRECISION FIX: Use camera-relative view matrix
	// Instead of translating the camera to pos_, we keep camera at origin
	// and translate the world by -pos_ (done in shader)
	// This maintains precision regardless of distance from world origin
	glm::vec3 origin(0.0f, 0.0f, 0.0f);
	return glm::lookAt(origin, getForward(), getUp());
}
